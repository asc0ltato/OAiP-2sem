...
{
	return key % size; //простой остаток от деления, при котором для каждого ключа вычисляется остаток от деления на размер хеш-таблицы. остаток - индекс ячейки в таблице, где будет храниться значение
}
//-------------------------------
