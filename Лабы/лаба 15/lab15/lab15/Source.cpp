...
//-------------------------------
//Используется при коллизии (два разных ключа имеют одинаковый хэш-код) для поиска следующей свободной ячейки в таблице
...
int HashFunctionU(int key, int size, int p)
{
