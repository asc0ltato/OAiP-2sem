...
//считывание списка из файла. Создать список, содержащий элементы целого типа. Найти сумму отрицательных элементов, кратных 5, или выдать сообщение,
...
//Находим сумму отрицательных элементов, кратных 5
void sum_negative_multiples_of_five(const vector<int>& list) {
    int sum = 0;
    ...
    if (has_multiples_of_five) {
        cout << "Сумма отрицательных элементов, кратных 5, равна " << sum << endl;
    } else {
...
int main() {
    ...
    do { //// выводим меню
        ...
        cout << "7. Найти сумму отрицательных элементов, кратных 5" << endl;
        cout << "8. Выход" << endl;
        ...
        case 6:
            ...
            break;
        case 7:
            sum_negative_multiples_of_five(list);
            break;
        case 8:
