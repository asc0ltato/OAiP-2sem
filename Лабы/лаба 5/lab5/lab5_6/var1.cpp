...
//считывание списка из файла. Создать список, содержащий элементы целого типа. Найти сумму положительных элементов, или выдать сообщение,
...
void sum(list* p)
{
	...
	else
	{
		...
		if (sm != 0) {
			cout << "Сумма положительных элементов: " << sm << endl;
		}
		else {
			cout << "Сумма положительных элементов не найдена (таких элементов нет) " << endl;
		}
	}
}