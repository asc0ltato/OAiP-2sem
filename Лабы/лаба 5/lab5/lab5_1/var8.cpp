...
//Находим сумму отрицательных элементов, кратных 2
void sumOfNegativeMultiplesOfTwo(const vector<int>& list) {
    int sum = 0;
    bool found = false;
    for (int i = 0; i < list.size(); i++) {
    ...
    if (found) {
        ...
        cout << "Нет отрицательных элементов, кратных 2." << endl;
    }
}
...
int main() {
    ...
    do { //// выводим меню
        ...
        case 6:
            ...
            break;
        case 7:
            sumOfNegativeMultiplesOfTwo(list);
            break;
        case 8:
